...
<input class="form-control" name="company_type" type="text" placeholder="Company type" value="{{ $company->type }}">

<input class="form-control" name="company_description" type="text" placeholder="Company description" value="{{ $company->description }}">
